...
CONSUMER_READ_TOOLS = LEGAL_READ_TOOLS
...
CONSUMER_AGENT = AgentProfile("consumer", "소비자 Agent", "소비자 법률 근거 검색", "환불·미배송·중고거래 분쟁", "돈을 보냈는데 물건을 받지 못했습니다.", "검색된 Evidence만 사용한다.", CONSUMER_READ_TOOLS)
