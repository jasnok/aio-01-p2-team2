...
@router.post("/questions/{question_id}/unlock")
...
@router.post("/questions/{question_id}/resubmit", status_code=201)
...
@router.patch("/admin/questions/{question_id}/answer")
...
class CommentBody(BaseModel):
    ...
    comment_password: str | None = Field(default=None, min_length=4, max_length=20)
...
@router.patch("/questions/{question_id}/comments/{comment_id}")
